...
export const PersonalTodoPage = (_: Props<{}>) => {
  // ── State ──────────────────────────────────────────────────────────────────
  ...
  onMount(() => {
    console.log("[PersonalTodoPage] mounted");
    return () => console.log("[PersonalTodoPage] unmounted");
  });
    ...
    <div class="app">
      ...
      <main class="main">
        ...
        <button class="add-btn" type="submit" ?disabled=${add.isLoading()}>
          ${add.isLoading() ? "Adding…" : "Add personal "}
        </button>
